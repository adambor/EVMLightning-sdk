...
export class EVMSwapper {
    ...
    static createSwapperOptions(chain: "Q" | "Q_TESTNET" | "POLYGON" | "POLYGON_TESTNET" | "LINEA_TESTNET" | "OKTC", maxFeeDifference?: BN, intermediaryUrl?: string, tokenAddresses?: {WBTC: string, USDC: string, USDT: string}): SwapperOptions {
